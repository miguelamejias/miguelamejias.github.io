...
tools: Bash, Glob, Grep, LS, Read, Edit, MultiEdit, Write, NotebookEdit, WebFetch, TodoWrite, WebSearch, BashOutput, KillBash, mcp__sequentialthinking__sequentialthinking, mcp__memory__create_entities, mcp__memory__create_relations, mcp__memory__add_observations, mcp__memory__delete_entities, mcp__memory__delete_observations, mcp__memory__delete_relations, mcp__memory__read_graph, mcp__memory__search_nodes, mcp__memory__open_nodes, ListMcpResourcesTool, ReadMcpResourceTool, mcp__StitchMCP__list_projects, mcp__StitchMCP__get_project, mcp__StitchMCP__list_screens, mcp__StitchMCP__get_screen, mcp__StitchMCP__generate_screen_from_text, mcp__StitchMCP__edit_screens, mcp__StitchMCP__generate_variants, mcp__StitchMCP__list_design_systems, mcp__StitchMCP__create_design_system, mcp__StitchMCP__update_design_system, mcp__StitchMCP__apply_design_system
model: opus
color: pink
---
